 ...
 * Get staged diff
 */
export const getStagedDiff = (): Promise<string> => {
 ...
 */
export const getHeadDiff = (): Promise<string> => {
...
export const getSubmodulePaths = async (): Promise<Set<string>> => {
  ...
  try {
    const result = await $`git config --file .gitmodules --get-regexp path`.quiet();
 ...
 */
export const getCommitsSince = async (ref: string): Promise<string> => {
  try {
 ...
 */
export const getDiffSince = async (ref: string): Promise<string> => {
  try {
