...
### Changed
- Update local model endpoint to OpenAI-compatible chat completions

## [0.3.9] - 2026-03-01

### Changed
- Improve AI text extraction and prompt parsing reliability

## [0.3.6] - 2026-02-22

### Fixed
- Fix AI model response handling to improve accuracy and reliability

## [0.3.3] - 2026-02-22

### Added
- Add prompt validation to prevent errors when the user submits empty input.

### Changed
- Update AI model to provide more accurate responses.
- Change startup banner from dynamic figlet to static ASCII art for faster display.
- Load startup banner lazily and asynchronously in bundled builds to reduce startup time.
